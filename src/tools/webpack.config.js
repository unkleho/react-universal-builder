...
const config = {
  ...
  resolve: {
    ...
    alias: {
      // SearchKit uses different version of React. Need to alias it.
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': Object.keys(process.env).reduce(function(o, k) {
        if (k == 'API_URL' && !isDebug) {
          console.log('Use production API url');
          console.log('Replace ' + process.env[k] + ' with ' + process.env['PROD_API_URL']);
          o[k] = JSON.stringify(process.env['PROD_API_URL']);
        } else if (k == 'GRAPHQL_URL' && !isDebug) {
          console.log('Use production GraphQL url');
          console.log('Replace ' + process.env[k] + ' with ' + process.env['PROD_GRAPHQL_URL']);
          o[k] = JSON.stringify(process.env['PROD_GRAPHQL_URL']);
        } else {
          // Skip TIMEOUT, use default time in config.js
          if (k == 'TIMEOUT' && !isDebug) {
